...
const btnAccion = e => {
    if (e.target.classList.contains("fa-check")) //en caso de que se pulse el check completamos tarea
    {
        tareas[e.target.dataset.id].completada = true;

    } else if (e.target.classList.contains("fa-ban")) //en caso que se pulse el ban, borramos tarea
    {
